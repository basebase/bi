    ...
    showConfirm = (id, type, flag) => {
        ...
        if (flag === 1) {
            if (transverse.indexOf(newId) === -1 || transverse.length === 0) {
                ...
                if (longitudinal.indexOf(newId) != -1) {
                    longitudinal.splice(longitudinal.indexOf(newId), 1)
                    l_flag = true
                    this.setState({
                ...
                transverse.splice(transverse.length, 0, newId)
                this.setState({
                    transverse: transverse
                }, () => console.log(this.state))
            }
        } else {
            if (longitudinal.indexOf(newId) === -1 || longitudinal.length === 0) {
                if (transverse.indexOf(newId) != -1) {
                    transverse.splice(transverse.indexOf(newId), 1)
                    t_flag = true
                    this.setState({
                        transverse: transverse
                    }, () => console.log(this.state))
                ...
                longitudinal.splice(longitudinal.length, 0, newId)
                this.setState({
                    longitudinal: longitudinal
                }, () => console.log(this.state))
            }
